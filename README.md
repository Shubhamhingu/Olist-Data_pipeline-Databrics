...
This folder defines all source code for the 'Olist_Ecommerce_Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_olist_ecommerce_pipeline.py" to get familiar with the syntax.
